...
8 декабря 2025
---
- Установлен Laravel v12.40.2.
- JS и CSS используются через Vite. Рефакторинг ресурсов.
- Установлен npm v10.9.0 .
- Установлен node v22.12.0 .
- Установлен jquery-3.7.1.js .
- Зафиксированы версии образов docker-compose .
- Экспортирована dice-box библиотека.

22 декабря 2025
---
- Исправлена работа dropdown-helper'а.
- Для параграфов добавлены типы: html или test.
- Добавлен черновой вариант для обучения/туториала.