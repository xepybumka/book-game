...
------
    1. Заполнить таблицу Противники
    2. Сохранение записей (начать с Противников)
    3. Отрефакторить также Параграфы, Оружие, Заметки, Предметы, аналогично Противникам
    4. Админка. Страницы просмотра для Параграфы, Оружие, Заметки, Предметы, Противники.
    5. Заполнить таблицу Параграфы, Оружие, Заметки, Предметы аналогично Противникам
