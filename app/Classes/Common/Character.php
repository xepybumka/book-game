...
class Character
{
    ...
    public function __construct(int $diceResult = 0) {
        ...
        $this->createCharacter($diceResult);
     ...
     * @param  int  $diceResult
     */
    private function createCharacter(int $diceResult) {
        $this->setStats($diceResult);
        $this->setWeapon(new Sword());
        $this->setFood(3);
        $this->setMoney(0);
    ...
    private function setStats(int $diceResult) {
        ...
        $this->power = $this->maxPower = $startParams['power'];
     ...
     */
    public function setMaxPower($maxPower): void
    {
